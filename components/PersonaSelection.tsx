...
const PersonaCard: React.FC<{ persona: Persona; onSelect: () => void }> = ({ persona, onSelect }) => (
  <button
    onClick={onSelect}
    className="bg-slate-800 p-4 sm:p-6 rounded-xl text-left w-full h-full hover:bg-orange-950/30 border border-slate-700 hover:border-orange-500 transition-all duration-200 flex items-start gap-4"
  >
  ...
  return (
    <div className="p-4 sm:p-8">
      <div className="text-center mb-12">
        ...
        <p className="text-slate-400 mt-2">Pick a companion to start your journey.</p>
      </div>
